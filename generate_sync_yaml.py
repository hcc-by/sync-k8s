...
def get_repo_aliyun_tags(image):
    ...
    token_url = "https://dockerauth.cn-hangzhou.aliyuncs.com/auth?scope=repository:hcc-k8s/{image}:pull&service=registry.aliyuncs.com:cn-hangzhou:26842".format(
        image=image_name)
    try:
    ...
    tag_url = "https://registry.cn-hangzhou.aliyuncs.com/v2/hcc-k8s/{image}/tags/list".format(image=image_name)
